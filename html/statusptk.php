...
if(!isset($_SESSION["LOGINIDUS_REKRUT"]))
{
    ?><script>alert('Silahkan login dahulu');</script><?php
    ?><script>document.location.href='index.php';</script><?php
    die(0);
}
if ($_SESSION["LOGINAKS_REKRUT"] != "Administrator" and $_SESSION["LOGINAKS_REKRUT"] != "HRD") {
    ...
    <body>
        ...
        <section id="main" role="main">
            ...
            <div class="container-fluid">
                <!-- START row -->
                <?php include "module/view/rekrutmen/status/v_tambahstatus.php"; ?>
                <!--/ END row -->
            </div>

...
if ($_SESSION["LOGINAKS_MT"] != "Administrator" and $_SESSION["LOGINDEP_MT"] != "DEPT-0033" and $_SESSION["LOGINDEP_MT"] != "DEPT-0040" and $_SESSION["LOGINDEP_MT"] != "DEPT-0011") {
    ...
    <body>
        ...
        <section id="main" role="main">
            ...
            <div class="container-fluid">
                <!-- START row -->
                <?php include "module/view/master/teknisi/v_tambahteknisi.php"; ?>
                <!--/ END row -->
            </div>

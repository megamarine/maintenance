            ...
            if (isset($_GET["KODE_PERBAIKAN"])) 
            {
                if ($_SESSION["LOGINDEP_MT"] == "DEPT-0040") 
                {
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="">Tanggal Perbaikan <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control" id="time-picker" name="JAM_START" value="<?php echo $JAM_START; ?>" placeholder="Select a time" />
                            </div>
                        </div>
                    </div>
                    <?php

...
$result = GetData1(
   ...
   "p.KODE_BARANG = b.KODE_BARANG and 
    ...
    (b.KODE_JENIS = 1 or p.KODE_DEPARTEMEN = '$KODE_DEPARTEMEN') 
...
while ($row = $result->fetch(PDO::FETCH_ASSOC)) 
{
    ...
    $result2 = GetQuery("select t.NAMA_TEKNISI from d_perbaikan p, m_teknisi t where p.KODE_TEKNISI = t.KODE_TEKNISI and p.KODE_PERBAIKAN = '$KODE_PERBAIKAN' and p.STS_HAPUS = 0");
        ...
        if ($row["STATUS"] == 0) {
            ...
            if (!isset($row["HASIL"])) {
                if ($KODE_DEPARTEMEN == $row["KODE_DEPARTEMEN"]) {
                    ...
                    <a href="tambah_hasil?KODE_PERBAIKAN=<?php echo $row["KODE_PERBAIKAN"]; ?>&HASIL=1" ><img src="images/emptystar.png"></a>&nbsp;<a href="tambah_hasil?KODE_PERBAIKAN=<?php echo $row["KODE_PERBAIKAN"]; ?>&HASIL=2" ><img src="images/emptystar.png"></a>&nbsp;<a href="tambah_hasil?KODE_PERBAIKAN=<?php echo $row["KODE_PERBAIKAN"]; ?>&HASIL=3" ><img src="images/emptystar.png"></a>&nbsp;<a href="tambah_hasil?KODE_PERBAIKAN=<?php echo $row["KODE_PERBAIKAN"]; ?>&HASIL=4" ><img src="images/emptystar.png"></a>&nbsp;<a href="tambah_hasil?KODE_PERBAIKAN=<?php echo $row["KODE_PERBAIKAN"]; ?>&HASIL=5" ><img src="images/emptystar.png"></a></td>
                    <?php
                }
                else{
                    ?>
                    ...
                    <img src="images/emptystar.png"><img src="images/emptystar.png"><img src="images/emptystar.png"><img src="images/emptystar.png"><img src="images/emptystar.png"></td>
                    <?php
                }
            }
            else{

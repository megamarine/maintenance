                ...
                <div class="row">
                    <div class="col-lg-6 col-lg-offset-3">
                        <div class="panel panel-minimal" style="margin-top:10%;">
                            ...
                            <div class="panel-body text-center">
                                <h1 class="semibold longshadow text-center text-default fsize32 mb10 mt0">UNDER MAINTENANCE!!</h1>
                            ...
                            <!-- Button -->
                            <div class="panel-body text-center">
                                <a href="menuutama.php" class="btn btn-default mb5">Back To Dashboard</a>
                                <span class="semibold text-default hidden-xs">
                            </div>
                            <!--/ Button -->
                        </div>
                    </div>
